...
from views.repos.repos import Create, View, Transport, Delete, \
        Setting, AddCommiter, DeleteCommiter
...
add_commiter = view_func(AddCommiter)
del_commiter = view_func(DeleteCommiter)
...
repos.add_url_rule('/<git>/<rname>/add', view_func=add_commiter, methods=['POST'])
repos.add_url_rule('/<git>/<tname>/<rname>/add', view_func=add_commiter, methods=['POST'])

repos.add_url_rule('/<git>/<rname>/remove', view_func=add_commiter, methods=['POST'])
repos.add_url_rule('/<git>/<tname>/<rname>/remove', view_func=del_commiter, methods=['POST'])
