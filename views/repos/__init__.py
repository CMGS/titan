...
add_commiter = view_func(AddCommiter, tmpl='commiter')
remove_commiter = view_func(RemoveCommiter)
...
repos.add_url_rule('/<git>/<rname>/commiter', view_func=add_commiter, methods=['GET', 'POST'])
repos.add_url_rule('/<git>/<tname>/<rname>/commiter', view_func=add_commiter, methods=['GET', 'POST'])
